  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[860px] text-center">
        <p className="mb-3.5 text-[11px] font-extrabold tracking-[2px] text-[#2DD4BF] uppercase">
          Our mission
        </p>
        <h2
        ...
        <p className="text-[clamp(15px,1.9vw,19px)] leading-relaxed text-[#AEBFCE] italic">
          At the heart of the sector&rsquo;s connectedness is the heart of the
          educator, and the hands of the pedagogue.
        </p>
        <p className="mx-auto mt-[18px] max-w-[640px] text-[clamp(14px,1.7vw,17px)] leading-[1.7] font-semibold text-[#CBD8E6]">
        ...
        <p className="mt-[22px] text-[clamp(16px,2vw,20px)] font-extrabold tracking-[0.3px] text-[#2DD4BF]">
