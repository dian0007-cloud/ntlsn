      ...
      <div className="mx-auto max-w-[880px]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-[26px]">
          <div className="grid min-w-full max-w-[360px] flex-1 gap-2.5 sm:min-w-[280px]">
            ...
            />
            <div className="text-[12px] text-[#8aa0b6]">
              Mentoring, assessing, peer review, calibration, presenting, it
              all counts.
            </div>
            <a
              href="/trp.html"
              className="mt-0.5 inline-flex items-center gap-1.5 self-start rounded-full bg-[#2DD4BF] px-4 py-[9px] text-[13px] leading-none font-bold text-[#06243a] no-underline"
            >
              Open the full builder →
            </a>
            <div className="text-[11.5px] text-[#8aa0b6]">
          ...
          <div className="min-w-[280px] flex-1">
            <div className="mx-auto max-w-[380px] rounded-[18px] bg-[linear-gradient(135deg,#2DD4BF,#7C9CFF,#C57BFF)] p-[1.5px]">
              <div className="rounded-[16.5px] bg-[#0c1c34] p-[22px]">
                ...
                <div className="my-4 flex gap-[22px]">
                  <div>
                    <div className="text-[26px] leading-none font-extrabold text-[#2DD4BF]">
                      {points}
                    </div>
                ...
                <div className="mb-3">
                  {CHIPS.map((chip) => (
                    <span
                      key={chip}
                      className="mr-[5px] mb-[5px] inline-block rounded-full border border-white/[0.14] bg-white/[0.06] px-[9px] py-[3px] text-[10.5px] font-semibold text-[#cbd8e6]"
                    >
                      {chip}
                    </span>
                  ))}
                </div>
                <div className="border-t border-white/[0.08] pt-2.5 text-[11px] font-semibold text-[#8aa0b6]">
                  Open Badges 3.0 · My eQuals · verifiable, portable
                </div>
                <div className="mt-1 text-[10.5px] text-[#8aa0b6]">
