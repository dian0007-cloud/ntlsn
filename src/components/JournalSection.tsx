...
export default function JournalSection() {
  return (
    ...
    >
      <div className="mx-auto max-w-[820px] rounded-[18px] border border-white/[0.09] bg-[#2a2218] p-[30px] text-center [border-top:3px_solid_#c9a962]">
        ...
        <p className="mx-auto mb-[18px] max-w-[640px] text-[clamp(14.5px,1.7vw,17px)] leading-[1.65] text-[#d9cdb6]">
