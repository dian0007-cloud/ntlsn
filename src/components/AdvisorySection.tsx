  ...
  return (
    ...
    >
      <div className="mx-auto mb-9 max-w-[860px] text-center">
        ...
        />
        <p className="mb-[15px] inline-block rounded-full border border-[#2DD4BF]/40 px-[13px] py-[5px] text-[11px] font-extrabold tracking-[2px] text-[#2DD4BF] uppercase">
          Advisory &amp; Alliance
        </p>
        <h2
      ...
      <div
        className="adv-card relative mx-auto max-w-[940px] overflow-hidden rounded-[20px] border border-[#2DD4BF]/[0.22] px-[22px] py-6 text-center"
        style={{
          animationDelay: "80ms",
          background:
            "radial-gradient(120% 140% at 50% 0%, rgba(45,212,191,0.13), rgba(124,156,255,0.06) 45%, rgba(12,28,52,0) 75%), #0C1C34",
        }}
      >
        <div
          aria-hidden="true"
        ...
        >
          <div className="absolute inset-0 rounded-full border border-[#2DD4BF]/[0.14]" />
          <div className="absolute inset-[80px] rounded-full border border-[#7C9CFF]/[0.12]" />
        ...
        <div className="relative">
          ...
          <p className="mx-auto mb-5 max-w-[680px] text-[clamp(14.5px,1.7vw,17px)] leading-[1.65] text-[#CBD8E6]">
          ...
          <div className="mb-[22px] flex flex-wrap justify-center gap-[9px]">
            {INTL_CHIPS.map((chip) => (
              <span
                key={chip}
                className="rounded-full border border-white/[0.12] bg-white/5 px-3.5 py-1.5 text-xs font-bold text-[#CBD8E6]"
              >
                {chip}
              </span>
            ))}
          ...
          <a
            href="#ntlsn-network"
            className="inline-block rounded-xl bg-[#2DD4BF] px-[26px] py-3 text-sm font-extrabold text-[#06243A] no-underline shadow-[0_8px_26px_rgba(45,212,191,0.28)]"
          >
      ...
      <div className="mt-10">
        ...
        <div className="mx-auto mb-10 max-w-[680px]">
          <div
            className="adv-card rounded-[18px] border border-white/[0.09] bg-[#0f1f3a] p-[26px] [border-top:3px_solid_#2DD4BF]"
            style={{ animationDelay: "0ms" }}
          >
            <div className="mb-3.5 flex flex-wrap items-center gap-4">
              <div
                aria-hidden="true"
                className="adv-ava flex h-[66px] w-[66px] flex-none items-center justify-center rounded-full text-[23px] font-extrabold text-[#06243A] shadow-[0_6px_18px_rgba(0,0,0,0.32)]"
                style={{
                  background: "linear-gradient(135deg,#2DD4BF,#7C9CFF)",
                }}
              >
                SD
              </div>
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-[3px] text-[13px] font-bold text-[#2DD4BF]">
                  Founder &amp; Chair, NTLSN
                </p>
                <p className="mt-0.5 text-[12.5px] font-semibold text-[#9FB3C8]">
                  Senior Academic Development Consultant · Learning &amp;
                  Teaching Futures, UniSQ
                </p>
                <p className="mt-[5px] text-[11px] font-semibold tracking-[0.3px] text-[#8AA0B6]">
                  BSc(MedChem) · BIE(S&amp;T) · GDIBA · MBA · EdD · SFHEA
                </p>
              </div>
            </div>
            <p className="mb-3 text-sm leading-[1.62] text-[#CBD8E6]">
            ...
            <p className="mb-3 border-t border-white/[0.07] pt-2.5 text-[11.5px] leading-[1.55] text-[#8499AD]">
      ...
      <div
        className="adv-card mx-auto mb-[18px] max-w-[940px] rounded-2xl border border-[#7C9CFF]/[0.22] px-[26px] py-6 text-center"
        style={{
          animationDelay: "240ms",
          background:
            "linear-gradient(120deg, rgba(124,156,255,0.08), rgba(197,123,255,0.06))",
        }}
      >
        <CircleLabel text="Sector & academic circle — forming" />
        <p className="mx-auto mb-3.5 max-w-[680px] text-[14.5px] leading-relaxed text-[#CBD8E6]">
        ...
        <div className="flex flex-wrap justify-center gap-2.5">
          <span className="rounded-[10px] border border-white/10 bg-[#0f1f3a] px-[15px] py-[9px] text-[13px] font-bold text-[#CBD8E6]">
