...
export default function Acknowledgement() {
  return (
    <div
      ...
      className="border-b border-[#c66c3f]/40 bg-gradient-to-r from-[#1f1810] to-[#2a2218] px-5 py-3 text-center text-[12.7px] leading-relaxed tracking-[0.1px] text-[#d3dde8]"
    >
      <span aria-hidden="true" className="text-[#c66c3f]">
        ◇
      </span>{" "}
