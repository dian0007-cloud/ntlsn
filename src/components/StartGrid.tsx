    ...
    >
      ...
      {HUB_DOORS.map((door) => (
        ...
        >
          <span
            aria-hidden="true"
            className="z-[1] h-[15px] w-[15px] flex-none rounded-full border-[1.5px] border-teal/60 bg-[#19130d] transition-colors group-hover:bg-teal group-hover:shadow-[0_0_12px_rgba(143, 176, 129,0.55)] motion-reduce:transition-none"
          />
