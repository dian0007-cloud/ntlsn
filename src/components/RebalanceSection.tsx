    ...
    >
      <div className="mx-auto max-w-[760px] text-center">
        ...
        <div className="mx-auto mt-6 max-w-[640px]">
          <div className="mb-1.5 flex justify-between text-[11px] font-semibold text-[#a0907a]">
          ...
          <div className="relative h-3.5">
            ...
            />
            <div className="absolute top-[9px] left-1/2 -translate-x-1/2 text-[10px] font-semibold text-[#a0907a]">
              balance
            </div>
          </div>
        </div>
